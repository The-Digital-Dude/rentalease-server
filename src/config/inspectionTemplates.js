...
const createElectricalTemplate = () => ({
  jobType: "Electrical",
  title: "Electrical & Smoke Alarm Safety Inspection",
  version: 2,
  metadata: {
    category: "compliance",
    durationEstimateMins: 60,
  ...
  sections: [
    {
      ...
      description: "Record key inspection details and access conditions for both gas and smoke alarm inspections.",
      fields: [
        {
          id: "inspection-date",
          label: "Inspection Date",
        ...
        {
          id: "previous-gas-service-date",
          label: "Previous Gas Service Date (if known)",
          type: "date",
          helpText: "Leave blank if unknown",
        },
        {
          id: "previous-smoke-service-date",
          label: "Previous Smoke Alarm Service Date (if known)",
          type: "date",
          helpText: "Leave blank if unknown",
        },
        {
          ...
          type: "multi-select",
          options: [
            { value: "full-access", label: "Full access to all areas" },
            { value: "keys-provided", label: "Keys provided" },
            { value: "tenant-present", label: "Tenant present" },
            { value: "pets-present", label: "Pets present" },
            { value: "limited-access", label: "Limited access" },
        ...
        {
          id: "access-notes",
          label: "Access Notes & Conditions",
          type: "textarea",
          placeholder: "Additional details about access conditions or restrictions",
        },
        {
          id: "overall-safety-outcome",
          label: "Overall Property Safety Outcome",
          type: "select",
          required: true,
          options: [
            { value: "all-compliant", label: "All systems compliant" },
            { value: "minor-issues", label: "Minor maintenance items identified" },
            { value: "work-required", label: "Work required for compliance" },
            { value: "urgent-work", label: "Urgent work required" },
          ],
          defaultValue: "all-compliant",
        },
      ],
    ...
    {
      id: "gas-installation",
      title: "Gas Installation & Components",
      description: "Inspect LP Gas cylinders, installation components, and safety systems.",
      fields: [
        {
          id: "lp-gas-cylinders",
          label: "LP Gas cylinders and associated components (Regulators, pigtails) installed correctly",
          type: "yes-no-na",
          required: true,
        },
        {
        ...
        {
          id: "gas-installation-condition",
          label: "Overall gas installation condition",
          type: "select",
          required: true,
          options: [
            { value: "excellent", label: "Excellent" },
    ...
    {
      id: "gas-appliances",
      title: "Gas Appliances Inspection",
      description: "Complete safety inspection of all gas appliances.",
      fields: [
        {
          id: "cooker-present",
        ...
        {
          id: "cooker-isolation-valve",
          label: "Cooker: Appliance isolation valve",
          type: "yes-no-na",
          required: true,
        },
        {
          id: "cooker-electrically-safe",
          label: "Cooker: Electrically safe",
          type: "yes-no-na",
          required: true,
        },
        {
          id: "cooker-adequate-ventilation",
          label: "Cooker: Adequate ventilation",
          type: "yes-no-na",
          required: true,
        },
        {
          id: "cooker-adequate-clearances",
          label: "Cooker: Adequate clearances to combustible surfaces",
          type: "yes-no-na",
          required: true,
        },
        {
        ...
        {
          id: "heater-isolation-valve",
          label: "Heater: Appliance isolation valve",
          type: "yes-no-na",
          required: true,
        },
        {
          id: "heater-adequate-ventilation",
          label: "Heater: Adequate ventilation",
          type: "yes-no-na",
          required: true,
        },
        {
          id: "heater-flue-condition",
          label: "Heater: Flue in good condition",
          type: "yes-no-na",
          required: true,
        },
        {
        ...
        {
          id: "hotwater-isolation-valve",
          label: "Hot Water: Appliance isolation valve",
          type: "yes-no-na",
          required: true,
        },
        {
          id: "hotwater-adequate-ventilation",
          label: "Hot Water: Adequate ventilation",
          type: "yes-no-na",
          required: true,
        },
        {
          id: "appliances-comments",
          label: "Gas Appliances Comments",
          type: "textarea",
          placeholder: "Add any observations about the gas appliances",
        },
        {
          id: "appliances-photo",
          label: "Gas Appliances Photo",
          type: "photo",
          required: false,
        },
      ],
    ...
    {
      id: "smoke-coverage",
      title: "Smoke Alarm Coverage & Compliance",
      description: "Verify required smoke alarm locations and coverage compliance per AS 3786 & RTA VIC.",
      fields: [
        {
          id: "storeys-covered",
          label: "Number of storeys with smoke alarm coverage",
          type: "number",
          required: true,
          defaultValue: 1,
        },
        {
          id: "hallway-coverage",
          label: "Hallways/corridors have appropriate smoke alarm coverage",
          type: "yes-no",
          required: true,
        },
        {
          id: "bedroom-proximity-coverage",
          label: "Areas near bedrooms have appropriate smoke alarm coverage",
          type: "yes-no",
          required: true,
        },
        {
          id: "stairway-coverage",
          label: "Stairways (if applicable) have appropriate coverage",
          type: "yes-no-na",
          required: true,
        },
        {
          id: "interconnection-required",
          label: "Interconnection required for this property",
          type: "yes-no",
          required: true,
        },
        {
          id: "coverage-compliance-status",
          label: "Overall coverage compliance status",
          type: "select",
          required: true,
          options: [
            { value: "fully-compliant", label: "Fully compliant with AS 3786 & RTA VIC" },
            { value: "compliant-minor-gaps", label: "Compliant with minor coverage gaps" },
            { value: "non-compliant-coverage", label: "Non-compliant - Inadequate coverage" },
            { value: "non-compliant-placement", label: "Non-compliant - Incorrect placement" },
          ],
          defaultValue: "fully-compliant",
        },
        {
          id: "coverage-comments",
          label: "Coverage Assessment Comments",
          type: "textarea",
          placeholder: "Details about smoke alarm coverage and any compliance issues",
        },
      ],
    },
    {
      id: "smoke-alarm-inventory",
      title: "Smoke Alarm Inventory & Testing",
      description: "Record details and test results for each individual smoke alarm.",
      fields: [
        {
          id: "total-alarms-count",
          label: "Total number of smoke alarms inspected",
          type: "number",
          required: true,
          defaultValue: 1,
        },
        {
          id: "alarm-records",
          label: "Individual Smoke Alarm Details",
          type: "repeater",
          required: true,
          fields: [
            {
              ...
              type: "text",
              required: true,
              placeholder: "e.g., ALM-01, Kitchen-01",
            },
            {
              id: "location",
              ...
              options: [
                ...
                { value: "living-room", label: "Living room" },
                { value: "stairway", label: "Stairway" },
                { value: "bedroom", label: "Inside bedroom" },
                { value: "other", label: "Other location" },
              ],
            },
            {
              id: "location-other",
              label: "Other Location (specify)",
              type: "text",
              placeholder: "Specify location if 'Other' selected above",
            },
            {
              id: "brand",
              label: "Brand & Model",
            ...
            },
            {
              ...
              required: true,
              options: [
                { value: "mains-240v", label: "Mains 240V" },
                { value: "battery-9v", label: "9V Battery" },
                { value: "lithium-10yr", label: "10-year Lithium Battery" },
                { value: "mains-battery-backup", label: "Mains with Battery Backup" },
              ],
              defaultValue: "mains-240v",
            },
            {
              id: "manufacture-date",
              label: "Manufacture Date",
              type: "date",
              helpText: "As shown on alarm label",
            },
            {
              id: "expiry-date",
              label: "Expiry Date",
              type: "date",
              helpText: "Replace by date shown on alarm",
            },
            {
              id: "age-years",
              label: "Age (Years)",
            ...
            {
              id: "push-test-result",
              label: "Push Button Test Result",
              type: "select",
              required: true,
              options: [
                { value: "pass", label: "Pass - Alarm sounded" },
                { value: "fail", label: "Fail - No sound" },
                { value: "weak-sound", label: "Weak sound" },
                { value: "not-tested", label: "Not tested" },
              ],
              defaultValue: "pass",
            },
            {
              ...
              type: "number",
              placeholder: "Measured sound level",
              helpText: "Minimum 85dB required",
            },
            {
              id: "battery-replaced-today",
              label: "Battery replaced during this service",
              type: "yes-no",
              defaultValue: "no",
            },
            {
              ...
              options: [
                ...
                { value: "dust-buildup", label: "Dust buildup" },
                { value: "paint-overspray", label: "Paint overspray" },
                { value: "damage-cracks", label: "Physical damage/cracks" },
                { value: "loose-mounting", label: "Loose mounting" },
            ...
            },
            {
              ...
              options: [
                ...
                { value: "non-compliant", label: "Non-Compliant" },
                { value: "requires-replacement", label: "Requires Replacement" },
                { value: "requires-maintenance", label: "Requires Maintenance" },
              ],
              defaultValue: "compliant",
            },
            {
          ...
          defaultValue: [
            {
              "alarm-id": "ALM-01",
              location: "hallway-bedrooms",
              brand: "Clipsal 755SMA",
              "alarm-type": "photoelectric",
              "power-source": "mains-240v",
              "push-test-result": "pass",
              "sound-level-db": 90,
              "battery-replaced-today": "no",
              "physical-condition": ["good"],
              "compliance-status": "compliant",
            },
          ],
        ...
        {
          id: "alarms-replaced-count",
          label: "Number of alarms replaced during this service",
          type: "number",
          required: true,
          defaultValue: 0,
        },
        {
          id: "smoke-testing-photo",
          label: "Smoke Alarm Testing Photo",
          type: "photo",
          required: false,
        },
      ],
    },
    {
      ...
      title: "Combined Compliance Assessment",
      description: "Overall assessment of gas safety and smoke alarm compliance for the property.",
      fields: [
        {
          id: "gas-compliance-status",
          label: "Gas Safety Compliance Status",
          type: "select",
          required: true,
          options: [
            { value: "fully-compliant", label: "Fully Compliant" },
            { value: "compliant-minor-issues", label: "Compliant with Minor Issues" },
            { value: "non-compliant-work-required", label: "Non-Compliant - Work Required" },
            { value: "non-compliant-urgent", label: "Non-Compliant - Urgent Work Required" },
          ],
          defaultValue: "fully-compliant",
        },
        {
          id: "smoke-compliance-status",
          label: "Smoke Alarm Compliance Status",
          type: "select",
          required: true,
          options: [
            { value: "fully-compliant", label: "Fully Compliant" },
        ...
        },
        {
          ...
          required: true,
          options: [
            { value: "fully-compliant", label: "Fully Compliant - All systems safe" },
            { value: "compliant-maintenance", label: "Compliant with maintenance items" },
            { value: "non-compliant-work-required", label: "Non-Compliant - Work required" },
            { value: "non-compliant-urgent", label: "Non-Compliant - Urgent work required" },
          ],
          defaultValue: "fully-compliant",
        ...
        {
          id: "next-gas-service-due",
          label: "Next Gas Service Due",
          type: "date",
          required: true,
          helpText: "Typically annually",
        },
        {
          id: "next-smoke-service-due",
          label: "Next Smoke Alarm Service Due",
          type: "date",
          required: true,
          helpText: "Typically annually",
        ...
        {
          id: "immediate-actions-required",
          label: "Immediate Actions Required",
          type: "multi-select",
          options: [
            { value: "none", label: "No immediate actions required" },
            { value: "gas-repair", label: "Gas system repair required" },
            { value: "smoke-replacement", label: "Smoke alarm replacement required" },
            { value: "battery-replacement", label: "Battery replacement required" },
            { value: "professional-service", label: "Professional service required" },
            { value: "urgent-repair", label: "Urgent repair required" },
          ],
          defaultValue: ["none"],
        },
        {
          ...
          type: "textarea",
          placeholder: "List any recommendations for maintenance or improvements",
        },
        {
          id: "general-comments",
          label: "General Comments",
          type: "textarea",
          placeholder: "Additional observations about the property's gas and smoke alarm systems",
        },
      ],
    },
    {
      ...
      description: "Photographic evidence and required certifications.",
      fields: [
        {
          id: "overview-photos",
          label: "Property Overview Photos",
          type: "photo-multi",
          helpText: "General photos showing property layout and safety systems",
          metadata: { max: 4 },
        },
        {
          id: "gas-evidence-photos",
          label: "Gas Installation Evidence Photos",
          type: "photo-multi",
          helpText: "Photos of gas installations, appliances, and test equipment readings",
          metadata: { max: 6 },
        },
        {
          id: "smoke-evidence-photos",
          label: "Smoke Alarm Evidence Photos",
          type: "photo-multi",
          helpText: "Photos of smoke alarms, testing process, and compliance evidence",
          metadata: { max: 6 },
        },
        {
          id: "inspector-details-company",
          label: "Inspector Company/Organization",
          type: "text",
          required: true,
          defaultValue: "RentalEase Technical Services",
        },
        ...
        },
        {
          ...
          required: true,
          options: [
            { value: "as3786-2014", label: "AS 3786:2014 Smoke alarms" },
            { value: "rta-vic-2021", label: "Residential Tenancies Act (Victoria) 2021" },
            { value: "gas-safety-vic", label: "Gas Safety (Victoria) Regulations" },
            { value: "building-regulations", label: "Building Regulations 2018 (Victoria)" },
          ],
          defaultValue: ["as3786-2014", "rta-vic-2021", "gas-safety-vic"],
        },
        {
          id: "declaration-qualified",
          label: "I declare that I am appropriately qualified and licensed to conduct gas safety and smoke alarm inspections",
          type: "checkbox",
          required: true,
        },
        {
