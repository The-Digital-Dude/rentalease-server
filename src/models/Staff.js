...
const staffSchema = new mongoose.Schema(
  {
    ...
    // Polymorphic Reference - Staff can belong to either SuperUser or Agency
    owner: {
      ownerType: {
        type: String,
...
staffSchema.statics.findByTradeType = function (
  tradeType,
  ownerType = null,
  ownerId = null
) {
...
staffSchema.statics.findByRegion = function (
  regions,
  ownerType = null,
  ownerId = null
) {
