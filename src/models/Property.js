...
propertySchema.methods.hasOverdueCompliance = function() {
  ...
  return (
    (compliance.gasCompliance.nextInspection && compliance.gasCompliance.nextInspection < now) ||
    (compliance.electricalSafety.nextInspection && compliance.electricalSafety.nextInspection < now) ||
    (compliance.smokeAlarms.nextInspection && compliance.smokeAlarms.nextInspection < now) ||
    (compliance.poolSafety.required && compliance.poolSafety.nextInspection && compliance.poolSafety.nextInspection < now)
  );
};
...
propertySchema.index({ 'complianceSchedule.electricalSafety.nextInspection': 1 });
